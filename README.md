...
1. Download [WebEngage Xamarin Android Library (v0.2.0.0)](https://s3-us-west-2.amazonaws.com/webengage-sdk/xamarin/android/0.3.0.0/WebEngageXamarinAndroid.dll).
